...
class SessionHandler implements SessionHandlerInterface, SessionIdInterface, SessionUpdateTimestampHandlerInterface {
  ...
  public function open($path, $name): bool {
    ...
    $this->maxLifetime = \Civi::settings()->get('standaloneusers_session_max_lifetime');
  ...
  public function validateId($id): bool {
    ...
    return strtotime($session['last_accessed']) >= strtotime("- {$this->maxLifetime} seconds");
  }
  ...
  public function write($id, $data): bool {
    $session = Session::write($this->db, $id, $data);
